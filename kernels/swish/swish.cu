...
__global__ void swish_f32_kernel(float *__restrict__ x, float *__restrict__ y,
                                 int N) {
...
__global__ void swish_f32x4_kernel(float *__restrict__ x,
...
__global__ void swish_f16_kernel(half *__restrict__ x, half *__restrict__ y,
                                 int N) {
  int idx = blockIdx.x * blockDim.x + threadIdx.x;
  if (idx < N)
...
__global__ void swish_f16x2_kernel(half *__restrict__ x, half *__restrict__ y,
                                   int N) {
...
__global__ void swish_f16x8_kernel(half *__restrict__ x, half *__restrict__ y,
                                   int N) {
...
__global__ void swish_f16x8_pack_kernel(half *__restrict__ x,
